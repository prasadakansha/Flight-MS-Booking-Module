...
public class BookingController {
	...
	public ResponseEntity<BookingResponseDto> addBooking(@RequestBody BookingRequestDto bookingRequestDto) {
		...
		BigInteger userId = new BigInteger(bookingRequestDto.getUserId());
		booking.setUserId(userId);
		booking.setBookingDate(bookingDate);
		BigInteger flightNumber = new BigInteger(bookingRequestDto.getFlightNumber());
	...
	public BookingResponseDto convert(BookingRequestDto bookingRequestDto) {
		...
		BigInteger flightNumber = new BigInteger(bookingRequestDto.getFlightNumber());
		FlightScheduleDto flightScheduleDto = getScheduleFlightDetails(flightNumber);
		...
		BigInteger userId = new BigInteger(bookingRequestDto.getUserId());
		User userDetailsDto = fetchUserDetailsById(userId);

		bookingResponseDto.setUserId(userDetailsDto.getUserId().toString());
		bookingResponseDto.setUserPhone(userDetailsDto.getUserPhone().toString());
	...
	public List<BigInteger> passengerList(BookingRequestDto bookingRequestDto) {
		...
		for (Passenger passenger : passengerDetailsList) {
			...
			BigInteger passengerUIN = new BigInteger(passenger.getPassengerUIN());

			passengerList.add(passengerUIN);
		}
